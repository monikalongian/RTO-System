...
<button type="button" class="btn btn-info" onclick="window.location.href = 'insertp.html';">Add Pollution</button>
 ...
 ?>
  <tbody>
    <tr>
      ...
      <td><button type="button" class="btn btn-secondary" onclick="window.location.href = 'pollutionupdate.php?rcno=<?php echo $row['rcno']; ?>';">update </button></td>
      <td><button type="button" class="btn btn-secondary" onclick="window.location.href = 'pdelete.php?rcno=<?php echo $row['rcno']; ?>';">delete</button></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
